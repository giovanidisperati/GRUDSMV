...
O mais difícil era o Desafio que acabamos de implementar! Então caso não tenha conseguido, tente, agora a partir do código fornecido acima, fazer as implementações das melhorias pedidas nos exercícios 1 a 4 da aula anterior. 

>Nas seções seguintes desta aula, você encontrará a implementação completa dos exercícios da Aula 04, com o código-fonte comentado. Use como referência depois de ter tentado — o atrito da tentativa é parte do aprendizado.
